...
public class ManageRequestsController implements Initializable {
    ...
    @FXML private Tab leaveRequestTab;
    @FXML private Tab shiftChangeTab;
    
    // Leave Request Tab
    @FXML private TableView<LeaveRequest> leaveRequestTable;
    @FXML private TableColumn<LeaveRequest, Integer> leaveRequestIdColumn;
    @FXML private TableColumn<LeaveRequest, String> leaveStaffNameColumn;
    @FXML private TableColumn<LeaveRequest, String> leaveDateColumn;
    @FXML private TableColumn<LeaveRequest, String> leaveReasonColumn;
    @FXML private TableColumn<LeaveRequest, String> leaveStatusColumn;
    @FXML private TableColumn<LeaveRequest, String> leaveRequestDateColumn;
    @FXML private TableColumn<LeaveRequest, String> leaveApprovedByColumn;
    @FXML private Button approveLeaveButton;
    @FXML private Button rejectLeaveButton;
    @FXML private TextArea leaveResponseNoteArea;
    
    // Shift Change Request Tab
    @FXML private TableView<ShiftChangeRequest> shiftChangeTable;
    @FXML private TableColumn<ShiftChangeRequest, Integer> shiftChangeIdColumn;
    @FXML private TableColumn<ShiftChangeRequest, String> shiftStaffNameColumn;
    @FXML private TableColumn<ShiftChangeRequest, String> currentDateColumn;
    @FXML private TableColumn<ShiftChangeRequest, String> currentShiftColumn;
    @FXML private TableColumn<ShiftChangeRequest, String> desiredDateColumn;
    @FXML private TableColumn<ShiftChangeRequest, String> desiredShiftColumn;
    @FXML private TableColumn<ShiftChangeRequest, String> shiftReasonColumn;
    @FXML private TableColumn<ShiftChangeRequest, String> shiftStatusColumn;
    @FXML private TableColumn<ShiftChangeRequest, String> shiftRequestDateColumn;
    @FXML private TableColumn<ShiftChangeRequest, String> shiftApprovedByColumn;
    @FXML private Button approveShiftButton;
    @FXML private Button rejectShiftButton;
    @FXML private TextArea shiftResponseNoteArea;
    
    // Common Controls
    @FXML private ComboBox<RequestStatus> leaveStatusFilter;
    @FXML private ComboBox<RequestStatus> shiftStatusFilter;
    ...
    private void setupLeaveRequestTable() {
        ...
        leaveStaffNameColumn.setCellValueFactory(cellData -> {
            String name = cellData.getValue().getStaff() != null ? 
                         cellData.getValue().getStaff().getFullName() : "N/A";
    ...
    private void setupShiftChangeTable() {
        ...
        currentShiftColumn.setCellValueFactory(cellData -> {
            String shift = cellData.getValue().getCurrentShift() != null ? 
                          cellData.getValue().getCurrentShift().name() : "N/A";
        ...
        desiredShiftColumn.setCellValueFactory(cellData -> {
            String shift = cellData.getValue().getDesiredShift() != null ? 
                          cellData.getValue().getDesiredShift().name() : "N/A";
            return new SimpleStringProperty(shift);
        });
    ...
    private void setupTableListeners() {
        leaveRequestTable.getSelectionModel().selectedItemProperty().addListener(
            (obs, oldVal, newVal) -> updateLeaveRequestButtons(newVal));
        
        shiftChangeTable.getSelectionModel().selectedItemProperty().addListener(
            (obs, oldVal, newVal) -> updateShiftChangeButtons(newVal));
    }
    ...
    private void loadLeaveRequests() {
        ObservableList<LeaveRequest> requests = FXCollections.observableArrayList(
            requestService.getAllLeaveRequests());
        leaveRequestTable.setItems(requests);
        filterLeaveRequests();
    }
    
    private void loadShiftChangeRequests() {
        ObservableList<ShiftChangeRequest> requests = FXCollections.observableArrayList(
            requestService.getAllShiftChangeRequests());
    ...
    private void filterLeaveRequests() {
        ...
        if (selectedStatus == null) {
            ...
            // Filter by status
            ObservableList<LeaveRequest> filteredRequests = allRequests.filtered(
                request -> request.getStatus() == selectedStatus);
    ...
    private void filterShiftChangeRequests() {
        ...
        if (selectedStatus == null) {
            ...
            // Filter by status
            ObservableList<ShiftChangeRequest> filteredRequests = allRequests.filtered(
                request -> request.getStatus() == selectedStatus);
    ...
    private void handleApproveLeave() {
        ...
        if (success) {
            ...
            showAlert(AlertType.ERROR, "Lỗi", "Phê duyệt thất bại", 
    ...
    private void handleRejectLeave() {
        ...
        String note = leaveResponseNoteArea.getText().trim();
        if (note.isEmpty()) {
            showAlert(AlertType.WARNING, "Cảnh báo", "Thiếu lý do", 
        ...
        if (success) {
            ...
            showAlert(AlertType.ERROR, "Lỗi", "Từ chối thất bại", 
