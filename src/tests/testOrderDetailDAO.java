...
//
//		OrderDetail newOrderDetail = new OrderDetail(0, testOrder, testService, 2,
//				BigDecimal.valueOf(testService.getCostPrice()));
...
//					+ ", ServiceID: " + od.getService().getServiceID() + ", Quantity: " + od.getQuantity() + ", Price: "
//					+ od.getUnitPrice());
//		}
//
