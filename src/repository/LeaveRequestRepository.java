...
public class LeaveRequestRepository implements IRepository<LeaveRequest> {
    ...
    public List<LeaveRequest> selectAll() {
        ...
        String sql = "SELECT lr.*, s.full_name as staff_name, a.full_name as approver_name " +
                     "FROM leave_requests lr " +
                     "JOIN person p ON lr.staff_id = p.person_id " +
                     "JOIN person s ON lr.staff_id = s.person_id " +
                     "LEFT JOIN person a ON lr.approved_by = a.person_id " +
