...
public class Appointment {
	...
	public Appointment(String appointmentId, String customerName, String petName, String service, String time,
			String status) {
	...
	public String toString() {
		return "Appointment{" + "appointmentId='" + appointmentId + '\'' + ", customerName='" + customerName + '\''
				+ ", petName='" + petName + '\'' + ", service='" + service + '\'' + ", time='" + time + '\''
				+ ", status='" + status + '\'' + '}';
	}
}