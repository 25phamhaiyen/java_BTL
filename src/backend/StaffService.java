...
public class StaffService {
    ...
    public boolean updateStaff(Staff staff) {
        try {
            ...
            Staff existing = staffDAO.selectById(staff.getStaffID());
            if (existing == null) {
    ...
    public boolean deleteStaff(int staffId) {
        try {
            ...
            int result = staffDAO.delete(staff);
            return result > 0;
        } catch (Exception e) {
    ...
    public List<Staff> searchStaffs(String condition, Object... params) {
        try {
            return staffDAO.selectByCondition(condition, params);
        } catch (Exception e) {
    ...
    public boolean isPhoneNumberExists(String phoneNumber, Integer excludeStaffId) {
        try {
            return staffDAO.selectByCondition("phoneNumber = ? AND staffID != ?", phoneNumber, excludeStaffId != null ? excludeStaffId : 0)
                         .size() > 0;
        } catch (Exception e) {
    ...
    public boolean isCitizenNumberExists(String citizenNumber, Integer excludeStaffId) {
        try {
            return staffDAO.selectByCondition("citizenNumber = ? AND staffID != ?", citizenNumber, excludeStaffId != null ? excludeStaffId : 0)
                         .size() > 0;
        } catch (Exception e) {
